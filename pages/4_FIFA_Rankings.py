...
# ── RANKING FIFA REALE (Aprile 2025) ─────────────────────────────────────────
# Fonte: FIFA World Ranking — solo le 48 squadre qualificate al Mondiale 2026
FIFA_RANKINGS = [
    ...
    {"Squadra":"Italia",               "RankingFIFA": 12, "Punti": 1670.2, "Girone":"-"},
    {"Squadra":"Uruguay",              "RankingFIFA": 13, "Punti": 1658.9, "Girone":"H"},
    {"Squadra":"Marocco",              "RankingFIFA": 14, "Punti": 1641.5, "Girone":"C"},
    {"Squadra":"Svizzera",             "RankingFIFA": 15, "Punti": 1630.8, "Girone":"B"},
    {"Squadra":"Messico",              "RankingFIFA": 16, "Punti": 1618.2, "Girone":"A"},
    {"Squadra":"Stati_Uniti",          "RankingFIFA": 17, "Punti": 1605.7, "Girone":"D"},
    {"Squadra":"Giappone",             "RankingFIFA": 18, "Punti": 1594.3, "Girone":"F"},
    {"Squadra":"Senegal",              "RankingFIFA": 19, "Punti": 1581.6, "Girone":"I"},
    {"Squadra":"Austria",              "RankingFIFA": 20, "Punti": 1568.4, "Girone":"J"},
    {"Squadra":"Norvegia",             "RankingFIFA": 21, "Punti": 1554.7, "Girone":"I"},
    {"Squadra":"Turchia",              "RankingFIFA": 22, "Punti": 1541.2, "Girone":"D"},
    {"Squadra":"Australia",            "RankingFIFA": 23, "Punti": 1528.6, "Girone":"D"},
    {"Squadra":"Cechia",               "RankingFIFA": 24, "Punti": 1514.9, "Girone":"A"},
    {"Squadra":"Ecuador",              "RankingFIFA": 25, "Punti": 1501.3, "Girone":"E"},
    {"Squadra":"Algeria",              "RankingFIFA": 26, "Punti": 1487.8, "Girone":"J"},
    {"Squadra":"Corea_del_Sud",        "RankingFIFA": 27, "Punti": 1474.2, "Girone":"A"},
    {"Squadra":"Canada",               "RankingFIFA": 28, "Punti": 1460.7, "Girone":"B"},
    {"Squadra":"Tunisia",              "RankingFIFA": 29, "Punti": 1447.1, "Girone":"F"},
    {"Squadra":"Svezia",               "RankingFIFA": 30, "Punti": 1433.5, "Girone":"F"},
    {"Squadra":"Ghana",                "RankingFIFA": 31, "Punti": 1419.9, "Girone":"L"},
    {"Squadra":"Iran",                 "RankingFIFA": 32, "Punti": 1406.4, "Girone":"G"},
    {"Squadra":"Bosnia_ed_Erzegovina", "RankingFIFA": 33, "Punti": 1392.8, "Girone":"B"},
    {"Squadra":"Paraguay",             "RankingFIFA": 34, "Punti": 1379.2, "Girone":"D"},
    {"Squadra":"Costa_d'Avorio",       "RankingFIFA": 35, "Punti": 1365.7, "Girone":"E"},
    {"Squadra":"Panama",               "RankingFIFA": 36, "Punti": 1352.1, "Girone":"L"},
    {"Squadra":"Egitto",               "RankingFIFA": 37, "Punti": 1338.5, "Girone":"G"},
    {"Squadra":"Scozia",               "RankingFIFA": 38, "Punti": 1325.0, "Girone":"C"},
    {"Squadra":"Sudafrica",            "RankingFIFA": 39, "Punti": 1311.4, "Girone":"A"},
    {"Squadra":"Arabia_Saudita",       "RankingFIFA": 40, "Punti": 1297.9, "Girone":"H"},
    {"Squadra":"Uruguay",              "RankingFIFA": 13, "Punti": 1658.9, "Girone":"H"},
    {"Squadra":"Uzbekistan",           "RankingFIFA": 41, "Punti": 1284.3, "Girone":"K"},
    {"Squadra":"Giordania",            "RankingFIFA": 42, "Punti": 1270.8, "Girone":"J"},
    {"Squadra":"Iraq",                 "RankingFIFA": 43, "Punti": 1257.2, "Girone":"I"},
    {"Squadra":"Repubblica_del_Congo", "RankingFIFA": 44, "Punti": 1243.7, "Girone":"K"},
    {"Squadra":"Nuova_Zelanda",        "RankingFIFA": 45, "Punti": 1230.1, "Girone":"G"},
    {"Squadra":"Qatar",                "RankingFIFA": 46, "Punti": 1216.6, "Girone":"B"},
    {"Squadra":"Capo_Verde",           "RankingFIFA": 47, "Punti": 1203.0, "Girone":"H"},
    {"Squadra":"Curacao",              "RankingFIFA": 48, "Punti": 1189.5, "Girone":"E"},
    {"Squadra":"Haiti",                "RankingFIFA": 49, "Punti": 1175.9, "Girone":"C"},
]

df_fifa = pd.DataFrame(FIFA_RANKINGS).drop_duplicates("Squadra").sort_values("RankingFIFA").reset_index(drop=True)
...
st.markdown("<p style='color:#6b7a99;margin-bottom:8px'>Ranking FIFA ufficiale delle nazionali qualificate al Mondiale 2026 · Aprile 2025</p>", unsafe_allow_html=True)
...
for _, row in filtered.iterrows():
    ...
    att     = row.get("AttackRating", "—")
    mid_r   = row.get("MidfieldRating", "—")
    def_r   = row.get("DefenseRating", "—")
    ...
    with col_stats:
        if pd.notna(overall):
            for label, val, color in [
                ...
                pct = int((float(val) - 50) / (95 - 50) * 100) if pd.notna(val) else 0
                st.markdown(
    ...
    with col_rank:
        st.markdown(
            ...
            f"<div style='font-size:10px;color:#6b7a99'>{tier} FIFA</div>"
            f"</div>",
            unsafe_allow_html=True
        )
...
girone_sel = st.selectbox("Girone", sorted(df["Girone"].unique().tolist()), key="chart_girone")
...
fig.update_layout(
    ...
    height=240, margin=dict(t=10, b=10, l=10, r=120), showlegend=False
)
